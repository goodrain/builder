...
# See http://doc.goodrain.com/usage/181933 for more information.
WARNING
      end
    end
...
For supported Ruby versions see http://doc.goodrain.com/usage/181933
Note: Only the most recent version of Ruby 2.1 is supported
#{error.message}
ERROR
    error message
  end
  ...
  def build_bundler
    instrument 'ruby.build_bundler' do
      log("bundle") do
        ...
        bundle_command << " -j4"
        mirrorcmd = "#{bundle_bin} config mirror.https://rubygems.org http://maven.goodrain.me/nexus/content/repositories/Rubygems/"
...
http://doc.goodrain.com/usage/181933
WARNING
        ...
        Dir.mktmpdir("libyaml-") do |tmpdir|
          ...
          instrument "ruby.bundle_install" do
            bundle_time = Benchmark.realtime do
              pipe("#{mirrorcmd}", out: "2>&1", env: env_vars, user_env: true)
...
=end
  ...
  def precompile_fail(output)
    ...
    if output.match(/(127\.0\.0\.1)|(org\.postgresql\.util)/)
      ...
      msg << "http://doc.goodrain.com/usage/181933\n"
    end
    error msg
  end
